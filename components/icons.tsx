// Icon components for the marketplace
...
export const SonicTokenIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
...
export const EllipsisHorizontalIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
