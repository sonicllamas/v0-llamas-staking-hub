...
export function NetworkBanner() {
  ...
  return (
    <div className="bg-[#0d2416] py-2 border-b border-green-800">
      <Container>
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white text-sm py-1 px-3 rounded-md transition-colors"
          >
            Switch Network
          </button>
        </div>
